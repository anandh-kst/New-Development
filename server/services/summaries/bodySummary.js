      ...
      if (isValidValue(bodyMetrics.weight_kg_float)) {
        metricsToSave.push(
          new Observation({
            ...
            metric_unit: METRIC_UOM[METRIC_TYPE.WEIGHT],
      ...
      if (isValidValue(bodyMetrics.height_cm_int)) {
        metricsToSave.push(
          new Observation({
            ...
            metric_unit: METRIC_UOM[METRIC_TYPE.HEIGHT],
            metric_source: "summary",
            source_type: sourceType,
            date,
          })
      ...
      if (isValidValue(bodyMetrics.bmi_float)) {
        metricsToSave.push(
          new Observation({
            ...
            metric_unit: METRIC_UOM[METRIC_TYPE.BMI],
            metric_source: "summary",
            source_type: sourceType,
            date,
          })
    ...
    if (glucose && isValidValue(glucose.blood_glucose_avg_mg_per_dL_int)) {
      metricsToSave.push(
        new Observation({
          ...
          metric_unit: METRIC_UOM[METRIC_TYPE.BLOOD_GLUCOSE],
          metric_source: "summary",
          source_type: sourceType,
          date,
        })
      ...
      if (isValidValue(bp.systolic_mmHg_int)) {
        metricsToSave.push(
          new Observation({
            ...
            metric_unit: METRIC_UOM[METRIC_TYPE.BLOOD_PRESSURE_SYSTOLIC],
            metric_source: "summary",
            source_type: sourceType,
            date,
          })
      ...
      if (isValidValue(bp.diastolic_mmHg_int)) {
        metricsToSave.push(
          new Observation({
            ...
            metric_unit: METRIC_UOM[METRIC_TYPE.BLOOD_PRESSURE_DIASTOLIC],
            metric_source: "summary",
            source_type: sourceType,
            date,
          })
      ...
      if (isValidValue(nutrition.calories_intake_kcal_float)) {
        metricsToSave.push(
          new Observation({
            ...
            metric_unit:METRIC_UOM[METRIC_TYPE.CALORIES_INTAKE],
            metric_source: "summary",
            source_type: sourceType,
            date,
          })
      ...
      if (isValidValue(nutrition.protein_intake_g_float)) {
        metricsToSave.push(
          new Observation({
            ...
            metric_unit: METRIC_UOM[METRIC_TYPE.PROTEIN_INTAKE],
            metric_source: "summary",
            source_type: sourceType,
            date,
          })
      ...
      if (isValidValue(nutrition.fat_intake_g_float)) {
        metricsToSave.push(
          new Observation({
            ...
            metric_unit:METRIC_UOM[METRIC_TYPE.FAT_INTAKE],
            metric_source: "summary",
            source_type: sourceType,
            date,
          })
      ...
      if (isValidValue(nutrition.carbohydrates_intake_g_float)) {
        metricsToSave.push(
          new Observation({
            ...
            metric_unit: METRIC_UOM[METRIC_TYPE.CARBS_INTAKE],
            metric_source: "summary",
            source_type: sourceType,
            date,
          })
